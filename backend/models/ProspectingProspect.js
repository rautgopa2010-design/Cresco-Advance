...
module.exports = (sequelize, DataTypes) => {
  const ProspectingProspect = sequelize.define(
    "prospectingProspect",
    {
      ...
      enquiryIdempotencyKey: { type: DataTypes.STRING, allowNull: true },
      aiGeneratedDrafts: { type: DataTypes.JSON, allowNull: true },
      activityHistory: { type: DataTypes.JSON, allowNull: true },
