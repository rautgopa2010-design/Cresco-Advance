...
const PermissionTable = ({ defaultPermissions, onEditModule }) => {
    const DEFAULT_MODULES = ["Enquiry", "Leads", "API Leads", "Followup", "Quotations", "Orders", "Payment", "Field Visits", "Customer", "Proforma Invoice", "Invoice", "Reports", "Incentive", "Master", "Tickets"];
