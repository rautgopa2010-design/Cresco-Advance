...
const EnquiryDetailsExcel = forwardRef(({ companyName, companyLogo }, ref) => {
    useImperativeHandle(ref, () => ({
        exportExcel: async (rows) => {
            const wb = new ExcelJS.Workbook();
            const ws = wb.addWorksheet("Enquiry Report");
            ...
            subHeaderCell.value = "Enquiry Details";
            ...
            rows.forEach((c) => {
                ...
                const assignedToNames = Array.isArray(c.assignedTo) ? c.assignedTo.join(", ") : "";
            ...
            saveAs(new Blob([buffer]), "Enquiry_Report.xlsx");
        },
    }));
...
export default EnquiryDetailsExcel;
