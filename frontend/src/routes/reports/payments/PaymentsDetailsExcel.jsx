...
const PaymentsDetailsExcel = forwardRef(({ companyName, companyLogo }, ref) => {
    useImperativeHandle(ref, () => ({
        exportExcel: async (rows) => {
            const wb = new ExcelJS.Workbook();
            const ws = wb.addWorksheet("Payments Report");
            ...
            subHeaderCell.value = "Payments Details";
            ...
            saveAs(new Blob([buffer]), "Payments_Report.xlsx");
        },
    }));
...
export default PaymentsDetailsExcel;