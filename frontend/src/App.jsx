                ...
                children: [
                    ...
                    },
                    {
                        ...
                        children: [
                            ...
                            { path: "hrms/provider", element: <HRMSDashboard /> },
                            { path: "hrms/provider/:section", element: <HRMSDashboard /> },
                            { path: "hrms/organization", element: <HRMSDashboard /> },
                            { path: "hrms/organization/:section", element: <HRMSDashboard /> },
                            { path: "hrms/employee", element: <HRMSDashboard /> },
                            { path: "hrms/employee/:section", element: <HRMSDashboard /> },
