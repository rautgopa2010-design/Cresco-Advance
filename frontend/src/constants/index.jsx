        ...
        links: [
            {
                ...
                defaultOpen: false,
                children: [
                    { label: "Email Inbox", moduleName: "Engagement Hub", path: "/leads/email", icon: Dot },
                    { label: "Call Center", moduleName: "Engagement Hub", path: "/leads/calls", icon: Dot },
                    { label: "WhatsApp", moduleName: "Engagement Hub", path: "/leads/whatsapp", icon: Dot },
                    { label: "Automation", moduleName: "Sales Automation", path: "/leads/automation", icon: Dot },
                    { label: "AI Suggestions", moduleName: "AI Sales Assistant", path: "/leads/ai-suggestions", icon: Dot },
                ],
            },
        ],
    },
